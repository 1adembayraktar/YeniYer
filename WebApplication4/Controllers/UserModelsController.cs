...
namespace WebApplication4.Controllers
{
    public class UserModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,UserType,company_id,Email")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,UserType,company_id,Email")] UserModel userModel)
        {
            if (id != userModel.Id)
            {
                return NotFound();
